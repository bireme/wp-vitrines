...
<div class="presentation row" id="<?php if (empty($basic_vitrine_presentation_id)) { echo 'presentationBOX'; } else { echo $basic_vitrine_presentation_id; }; ?>" style="<?php if (isset($basic_vitrine_presentation_bg)) { echo "background-color: $basic_vitrine_presentation_bg !important;"; } ?> <?php if (isset($basic_vitrine_presentation_textColor)) { echo "color: $basic_vitrine_presentation_textColor !important;"; } ?>">
